# Skydive OpenStack TripleO deployment scripts

This repository gathers scripts that help to deploy Skydive on an
OpenStack TripleO deployment.

## Documentation

Documentation can be found [here](http://skydive.network/documentation/deployment#openstack-tripleo)
